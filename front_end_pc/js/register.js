    ...
    methods: {
        ...
        check_username: function () {
            ...
            if (this.error_name == false) {
                axios.get(this.host + '/username/' + this.username + '/count/', {
                    ...
                    .then(response => {
                        if (response.data.entity.count > 0) {
        ...
        check_sms_code: function () {
            ...
            if (this.error_sms_code == false) {
                axios.get(this.host + '/check_codes/' + this.mobile + '/?sms_code='+this.sms_code, {
                    responseType: 'json'
                })
                    .catch(error => {
                        if (error.response.status == 400) {
                            if ('non_field_errors' in error.response.data) {
                                ...
                                this.error_sms_code_message = error.response.data.sms_code[0];
                            }
                            this.error_sms_code = true
                        } else {
                            this.error_sms_code = false;
